...
template <class Cap> struct PushRelabel {
    public:
    PushRelabel(int n) : _n(n), excess(n) {}

    void add_edge(int from, int to, Cap lower_cap, Cap upper_cap) {
